...
export function Services() {
    ...
    <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-oi mb-12">Serviços</h2>
          <div className="relative">
            <div className='overflow-hidden rounded-2xl' ref={emblaRef}>
              <div className='flex'>
                {services.map((item, index) => (
                  <div key={index} className="flex-[0_0_100%] min-w-0 md:flex-[0_0_calc(100%/2)] lg:flex-[0_0_calc(100%/3)] px-3">
                    <article className="bg-zinc-900 text-white rounded-2xl p-6 space-y-4 h-full flex flex-col select-none">
                      ...
                      <div className='border-t border-gray-700 flex pt-4 items-center justify-between'>
                        ...
                        <a
                          ...
                          className='flex items-center justify-center gap-2 hover:bg-amber-600 px-4 py-1 rounded-md duration-300'
                        >
            ...
            <button onClick={scrollPrev} className="bg-white flex items-center justify-center rounded-full shadow-xl w-10 h-10 absolute left-2 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10">
              <ChevronLeft className="w-6 h-6 text-zinc-500"/>
            </button>
            <button onClick={scrollNext} className="bg-white flex items-center justify-center rounded-full shadow-xl w-10 h-10 absolute -right-8 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10">
